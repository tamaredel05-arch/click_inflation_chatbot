...
export default function AnomalyDashboard({ data }) {
  ...
  function Level2View() {
    ...
    const chartData = rawData.map((item, index) => {
      ...
      const hourDisplay = `${String(item.event_hour).padStart(2, '0')}:00`;
      
      return {
        index: index,  // מפתח ייחודי
        hourDisplay: hourDisplay,  // מה שמוצג
        ...
        return (
          <div style={{
            ...
            <p style={{ margin: '0 0 5px 0', fontWeight: 'bold' }}>
              Hour: {payload[0].payload.hourDisplay}
            </p>
          ...
          <div style={{ minWidth: '1800px' }}>
            <ResponsiveContainer width="100%" height={400}>
              <LineChart data={chartData}>
                ...
                <Legend />
                {/* קווים מפרידים בין ימים */}
                <ReferenceLine x={23} stroke="#ff9800" strokeWidth={2} strokeDasharray="5 5" label={{ value: 'Day 2', position: 'top', fill: '#ff9800', fontSize: 12 }} />
                <ReferenceLine x={47} stroke="#ff9800" strokeWidth={2} strokeDasharray="5 5" label={{ value: 'Day 3', position: 'top', fill: '#ff9800', fontSize: 12 }} />
                <Line 
                  type="monotone" 
                  dataKey="clicks" 
                  stroke="#2196f3" 
                  ...
                  activeDot={{ 
                    ...
                    cursor: 'pointer',
                    onClick: (e, payload) => {
                      setSelectedHour(payload.payload.hour);
                      setCurrentLevel(3);
                    }
                  }}
                />
  ...
  // =====================
  function Level3View() {
    const appsData = data.level3?.[selectedMediaSource]?.[selectedHour] || [];
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ 
              ...
              Hour {selectedHour}:00 - Top 10 Apps by Click Deviation
            </p>
          </div>
          <button
          ...
          <div style={{ minWidth: '900px' }}>
            <ResponsiveContainer width="100%" height={500}>
              <BarChart data={appsData}>
                ...
                {/* עמודה 1: הקליקים בשעה הנוכחית */}
                <Bar 
                  dataKey="clicks_this_hour" 
                  fill="#2196f3" 
                  name="This Hour"
                />
                
                {/* עמודה 2: ממוצע 3 ימים */}
                <Bar 
                  dataKey="avg_3d_same_hour" 
                  fill="#4caf50" 
                  name="3-Day Avg"
                />
        ...
        <div style={{
          ...
          <strong>Analysis:</strong> Showing top 10 apps with highest deviation from normal behavior at hour {selectedHour}:00
        </div>
      </div>
    );
  }
